...
describe("production lint suppressions", () => {
  it("keeps the intentional production suppression tail on an explicit allowlist", () => {
    expect(summarizeSuppressions(collectProductionLintSuppressions())).toEqual([
      ...
      "extensions/feishu/src/monitor.acp-init-failure.lifecycle.test-support.ts|typescript/no-redundant-type-constituents|1",
      "extensions/feishu/src/monitor.bot-menu.lifecycle.test-support.ts|typescript/no-redundant-type-constituents|1",
      "extensions/feishu/src/monitor.card-action.lifecycle.test-support.ts|typescript/no-redundant-type-constituents|1",
      "extensions/feishu/src/monitor.reply-once.lifecycle.test-support.ts|typescript/no-redundant-type-constituents|1",
